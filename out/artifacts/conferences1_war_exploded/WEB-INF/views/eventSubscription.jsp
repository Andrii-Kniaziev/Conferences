...
<body>
    ...
    <a href="conferences?command=eventSubscriptionInfo&page=1">1</a>
    <a href="conferences?command=eventSubscriptionInfo&page=2">2</a>
    <a href="conferences?command=eventSubscriptionInfo&page=3">3</a>
    <br/>
